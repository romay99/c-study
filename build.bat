...
echo [2/5] 01_basics/basics.c 컴파일...
%CC% %CFLAGS% %INCLUDES% -c src/01_basics/basics.c -o basics.o
if errorlevel 1 goto error

echo [3/5] 02_pointers/pointers.c 컴파일...
%CC% %CFLAGS% %INCLUDES% -c src/02_pointers/pointers.c -o pointers.o
if errorlevel 1 goto error

echo [4/5] 03_struct/struct.c 컴파일...
%CC% %CFLAGS% %INCLUDES% -c src/03_struct/struct.c -o struct.o
if errorlevel 1 goto error

echo [5/5] 04_memory/memory.c 컴파일 및 링크...
%CC% %CFLAGS% %INCLUDES% -c src/04_memory/memory.c -o memory.o
if errorlevel 1 goto error
